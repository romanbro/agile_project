   ...
   <section class="ftco-section contact-section ftco-degree-bg">
      ...
      <div style="padding-bottom:20px;">
          ...
          <div id="Code" class="tabcontent">
            <p>Search by code of procedure
            </p>
            <form action="#">
                
                <div class="form-group">
                  <input type="number" class="form-control" name="procCode" placeholder="111" maxlength="3">
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="location" placeholder="Location">
                </div>
                <div class="form-group">
                  <input type="number" class="form-control" name="minPrice" min="2000" max="3000000" placeholder="$ Min Price" oninvalid="this.setCustomValidity('The lowest price for a procedure is $2,000.')">
                </div>
                <div class="form-group">
                  <input type="number" class="form-control" name="maxPrice" min="2000" max="3000000" placeholder="$ Max Price" oninvalid="this.setCustomValidity('The highest cost for a procedure is $3,000,000.')">
                </div>
          ...
          <div id="Description" class="tabcontent">
            ...
            <form action="#">
                <div class="form-group">
                  <input type="text" class="form-control" name="prodDesc" placeholder="Chest Pain">
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="location" placeholder="Location">
                </div>
        ...
        <div class="row block-9">
          <div class="col-md-6 pr-md-5">
            ...
            <div>
              <table id = "outputTable" align="center" class="test1" style= "text-align:center; display:block; border:1px solid #17a2b8;  height: 400px; overflow-y: scroll; width:100%;">
                <tr>
                ...
                <tr>
                  <td style="width:30%"><input type="text" style="border:none; width:100%" name="ProcedureName"></td>
                  <td style="width:20%"><input type="text" style="border:none; width:100%" name="Hospital"></td>
                  <td style="width:30%"><input type="text" style="border:none; width:100%" name="Address"></td>
                  <td style="width:10%"><input type="text" style="border:none; width:100%" name="Price"></td>
                  <td style="width:10%"><input type="text" style="border:none; width:100%" name="Distance"></td>
                </tr> 
                <tr>
                  <td style="width:30%"><input type="text" style="border:none; width:100%" name="ProcedureName"></td>
                  <td style="width:20%"><input type="text" style="border:none; width:100%" name="Hospital"></td>
